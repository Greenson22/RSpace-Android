// lib/features/quiz/presentation/dialogs/generate_prompt_from_subject_dialog.dart
...
void showGeneratePromptFromSubjectDialog(BuildContext context) {
  final provider = Provider.of<QuizDetailProvider>(context, listen: false);
  showDialog(
    context: context,
    builder: (_) => ChangeNotifierProvider.value(
      value: provider,
      child: const GeneratePromptFromSubjectDialog(),
    ),
  );
}
...
class GeneratePromptFromSubjectDialog extends StatefulWidget {
  const GeneratePromptFromSubjectDialog({super.key});

  @override
  State<GeneratePromptFromSubjectDialog> createState() =>
      _GeneratePromptFromSubjectDialogState();
}

class _GeneratePromptFromSubjectDialogState
    extends State<GeneratePromptFromSubjectDialog> {
  ...
  Future<void> _handleGeneratePrompt() async {
    ...
    try {
      final prompt = await provider.generatePromptFromSubject(
    ...
    return Form(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            // Konten form sama seperti add_quiz_dialog
